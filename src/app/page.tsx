  ...
  return(
    <>
      ...
      <div className='mt-6 flex flex-col '>
        <div className='flex flex-col justify-between gap-4 pb-5 border-b border-zinc-200 dark:border-zinc-700 lg:flex-row lg:items-center'>
          ...
          <div className='space-y-1'>
            ...
            <span className='text-sm text-zinc-500 dark:text-zinc-400'>
              Update your photo and pesonal details here
            </span>
          </div>
        ...
        <form id='settings' className='mt-6 flex flex-col gap-5 divide-y divide-zinc-200 dark:divide-zinc-700'>
          ...
          <div className='flex flex-col gap-3 lg:grid lg:grid-cols-form'>
            ...
            <div className='flex flex-col gap-6 lg:grid lg:grid-cols-2'>
              ...
              <div className='flex flex-col gap-3 lg:block'>
                ...
                <InputRoot>
                  <InputControl id='lastName' defaultValue='Augusto'/>
                </InputRoot>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form'>
            ...
            <div className='space-y-3'>
             ...
             <Textarea id='bio' defaultValue="I'm a Product Designer based in Melbourne, Australia. I specialize in UX/Ui design, brand strategy, and Webflow development."/>
            </div>  
          </div>
